...
public interface UserService {
    ...
    boolean addNewUser(String login, String password, String firstName, String street, String house, int apartment, String phone) throws ServiceException;
    ...
    User updateUser( String login,String name, String street, String house, int apartment, String phone) throws ServiceException;
