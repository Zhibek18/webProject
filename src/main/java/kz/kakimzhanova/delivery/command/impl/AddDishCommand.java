    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            if (orderListService.addDish(orderId, dishName)) {
                request.setAttribute(CommandParameterHolder.PARAM_ADDING_STATUS.getName(), CommandParameterHolder.PARAM_STATUS_ADDED.getName());
            } else {
                logger.log(Level.ERROR, "addDish returned false");
                request.setAttribute(CommandParameterHolder.PARAM_ADDING_STATUS.getName(), CommandParameterHolder.PARAM_STATUS_NOT_ADDED.getName());
            }
